...
Both local and global density dependence can be justified under
...
([0,1]), and *m* is the movement rate:
...
$$
\begin{aligned}
B_{t+1,MPA = 0} = (1 - u_t) \times ( B_{t,MPA = 0} + \frac{\phi + 1}{\phi}gB_{t,MPA = 0} \left(1 - \left(\frac{B_{t,MPA = 0}}{K \times (1 - R)}\right)^{\phi} \right) \\ +  m\left(B_{t,MPA = 1} - \frac{R}{1 - R}B_{t,MPA= 0}\right) ).
\end{aligned}
$$

Under "pooled" density dependence
...
$$
\begin{aligned}
B_{t+1,MPA = 0} = (1 - u_t) \times ( B_{t,MPA = 0} + (1 - R) \frac{\phi + 1}{\phi}gB_{t,Total} \left(1 - \left(\frac{B_{t,Total}}{K}\right)^{\phi} \right) \\ +  m\left(B_{t,MPA = 1} - \frac{R}{1 - R}B_{t,MPA=0}\right) ).
\end{aligned}
$$
...
## Country-Level Stocks, Global Density Dependence
