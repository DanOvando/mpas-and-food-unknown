...
knitr::opts_chunk$set(echo = FALSE, message = FALSE, warning = FALSE,include = FALSE, dev = "png", dpi = 300)
set.seed(225)
...
fig_2 <-   fig_2 + theme_cowplot(font_family = "Helvetica", font_size = 12) + theme(axis.title.x = element_text(size = 7))
...
We thank the authors of Sala *et al.* [@sala2021] for constructive discussions in the development of this manuscript,  as well as  A. MacNeil and B. Fulton for their helpful comments. 
