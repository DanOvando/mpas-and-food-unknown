...
yield_curve_plot <- (k_plot / space_plot) &  (theme_cowplot(font_family = "Helvetica") + theme(legend.position = "top", legend.title = element_text(size = 10), legend.text = element_text(size = 8),plot.caption = element_text(size = 7)))
